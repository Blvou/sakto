...
import { CategoryShortcutBar } from '@/src/features/listings/components/CategoryShortcutBar';
import {
...
export default function MarketplaceSearchScreen() {
  ...
  const listEmpty = useMemo(() => {
    ...
    return (
      <EmptyState
        ...
        onAction={() => router.push('/marketplace/categories')}
      />
    );
  }, [debouncedQuery, isError, isLoading, router]);
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      {!categoryId ? <CategoryShortcutBar selectedId={null} /> : null}
